document.addEventListener('DOMContentLoaded', () => {
  ...
  const menu = [
    ...
    },
    {
      ...
      category: "China",
      price: 5.99,
      img: "https://i.pinimg.com/originals/26/7d/80/267d80cce02091ab19237259c7bfc16a.jpg",
  ...
  // 'Allfoods' butonuna tıklanınca tüm yemekleri gösterme
  document.getElementById('Allfoods').addEventListener('click', () => {
    displayMenuItems(menu);
  });

  // 'Korea' butonuna tıklanınca Kore yemeklerini gösterme
  ...
  // 'Japan' butonuna tıklanınca Japon yemeklerini gösterme
  ...
  // 'China' butonuna tıklanınca Çin yemeklerini gösterme
  ...
  // Sayfa yüklendiğinde tüm yemekleri gösterme
  displayMenuItems(menu);
});
